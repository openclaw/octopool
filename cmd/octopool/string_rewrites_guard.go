...
func rewriteInternalShapeHeader(key, value string) bool {
	...
	return slices.Contains([]string{publicShapeActionsSummary, publicShapeActionsJobs, publicShapeIssueSummary, publicShapeIssueList, publicShapeIssueSearch, publicShapePullRequestList, publicShapePullRequestSummary, publicShapePullRequestFiles, publicShapePullRequestCISummary, publicShapePullRequestCIRollup, publicShapePullRequestMergeSnapshot, publicShapePullRequestComments, publicShapePullRequestCommits, publicShapeLabelList, publicShapeWorkflowList, publicShapeWorkflowView, publicShapeReleaseSummary, publicShapeReleaseMetadata}, value)
}
